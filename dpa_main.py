...
save_plot = True #Save the plot as a .png file
show_plot = True #Show the plot instantly after running the script

### THE GAS

n_tot = 1e18*1e6  # Total gas density
am_N2 = 99.   #Amount of total N2 molecules (including pre-ionized and non pre-ionized ones) in percent
pre_ion_level = 4 #The pre-ionization level of the N2 (0 = no pre-ionization)
...
if save_plot == True:	
	...
	print("Note: The option 'save_plot' is disabled\nThe plot wont't be saved!\n")
time.sleep(0.5)
