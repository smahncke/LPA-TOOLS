...
def ionization_probability(z,max_a,w0,ctau,zf,lambda_0,U_i,energy, plot=False, r = 0, t = 0):
    ...
    E_gauss = las.gaussian_field(z, max_a,lambda_0,w0,ctau,zf) 
    ...
    #E_L = 1.e2*np.sqrt(2.8e18/(lambda_0*const.c*epsilon_0))*E_gauss #Electrical field of the laser in V/m
    E_L = E_gauss
...
def get_min_a0(z,w0,ctau,zf,lambda_0,U_i,energy,max_a = 10,ion_thres = 0.01):
	...
	prob = ionization_probability(z,max_a,w0,ctau,zf,lambda_0,U_i,energy)

	#Calculate the ionization degree
	degree = ionization_degree(z,prob)

	#Get the laser envelope
	envelope = las.gaussian_envelope(z,max_a,ctau)
