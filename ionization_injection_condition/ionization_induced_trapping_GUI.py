...
"""
The following code block imports a wakefield in the case that it already exists.
Otherwise it will be calculated"""

wakefield = Path("wakefields/wakefield_a0_"+str(a0)+".dat")

if wakefield.exists():
	menu_1 = input("A wakefield .dat-file for a0: "+str(a0)+" does already exist,\ndo you want to import it?\n\n[y] Import data / [n] Calculate it again")
	if menu_1 == "n":
		...
		menu_2 = input("Do you want to export the wakefield this time so\nit can be imported the next time?\n\n[y] Yes / [n] No")
		if menu_2 == "n":
	...
	#	break
		...
		print("Importing wakefield, this take a moment...")
		phi = loadtxt("wakefields/wakefield_a0_"+str(a0)+".dat", delimiter=',')
		print("Wakefield imported successfully!")
		imported = True
	#	break
else:
	print("No wakefield found. It will be calculated manually..\nThis may take a moment...")
	# Initial conditions
	phiinit = array([0,0]) 
	start_timer_1 = time.time()		
	# Solve the quasi static plasma wave equation
...
def left_side(zz): # Left side of the trapping equation
    return 1 + get_phi_min(E_max,zz) - phi_array
