...
def gaussian_osc_field(z, max_a, w0, ctau, zf, lambda_0, r = 0, t = 0):
...
def gaussian_field_envelope(z, max_a, ctau,lambda_0 = 0.8):
	...
	a = gaussian_a0(z,max_a,ctau)
	
	return 3.21e12*a/lambda_0

#-------------------------------------
# Vector potential of the gaussian laser pulse
#-------------------------------------

def gaussian_a0(z, max_a, ctau):
